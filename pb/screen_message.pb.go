...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=pb1.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x70, 0x62, 0x31, 0x22, 0x8b, 0x02, 0x0a, 0x06,
	...
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x62, 0x31, 0x2e, 0x53, 0x63,
	...
	0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x70, 0x62, 0x31,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: pb1.Screen.Panel
	(*Screen)(nil),            // 1: pb1.Screen
	(*Screen_Resolution)(nil), // 2: pb1.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: pb1.Screen.resolution:type_name -> pb1.Screen.Resolution
	0, // 1: pb1.Screen.panel:type_name -> pb1.Screen.Panel
